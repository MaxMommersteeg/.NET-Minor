...
namespace Case2.MaRoWo.GarageAdministratie.Infrastructure.Agents.RdwIntegrationService
{
    ...
    /// </summary>
    public partial class RdwIntegrationServiceAgent : ServiceClient<RdwIntegrationServiceAgent>, IRdwIntegrationServiceAgent
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the RdwIntegrationServiceAgent class.
        /// </summary>
        /// <param name='handlers'>
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RdwIntegrationServiceAgent(params DelegatingHandler[] handlers) : base(handlers)
        {
            this.Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RdwIntegrationServiceAgent(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            this.Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RdwIntegrationServiceAgent(Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public RdwIntegrationServiceAgent(Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new ArgumentNullException("baseUri");
